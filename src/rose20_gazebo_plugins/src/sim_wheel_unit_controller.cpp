...
SimWheelUnitController::SimWheelUnitController(ros::NodeHandle n, string wheel_unit_name, int wheel_direction) 
{
  ...
  caster_joint_         = new SimJoint(1.0, 50.0, 0.0, 15.0);
  wheel_joint_          = new SimJoint(2.0, 75.0, 0.0, 15.0);

  // Initialize caster & wheel PID controllers
  PID_caster_.initialize(20.0, 0.1, 0.0, -1.0, 1.0, -5.0, 5.0);
  PID_wheel_.initialize(20.0, 0.1, 0.0, -1.0, 1.0, -7.5, 7.5);
